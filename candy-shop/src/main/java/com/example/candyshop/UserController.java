...
public class UserController {
	...
	//public UserController(InMemoryUserDetailsManager inMemUserDetManager) {
	//	this.inMemUserDetManager = inMemUserDetManager;
	//}
    ...
    public String postAction(@Valid @ModelAttribute("user") User user, Errors errors, Model model, HttpServletRequest request) {
